...
export function createCoreConfig(repoRoot, overrides = {}) {
...
export function loadOperations(repoRoot) {
    return readJson(path.join(repoRoot, "generated", "operations.json"));
}
export function loadPagingMap(repoRoot) {
    return readJson(path.join(repoRoot, "generated", "pagination-map.json"));
}
export function loadSwaggerDefinitions(repoRoot) {
    const swagger = readJson(path.join(repoRoot, "specs", "swagger.json"));
